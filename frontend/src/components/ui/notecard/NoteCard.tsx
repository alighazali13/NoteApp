...
function NoteCard({text, className, onlyMyClassNames, ...props} : TNoteCardProps) {
    const defaultClassNames = "w-full px-8 py-5 rounded-xl min-h-[5rem] sm:min-h-[10rem] sm:max-h-[10rem] 2xl:min-h-[13rem] 2xl:max-h-[13rem] flex items-center shadow-[0px_0px_6px_1px_rgba(22,22,22,1)]";
